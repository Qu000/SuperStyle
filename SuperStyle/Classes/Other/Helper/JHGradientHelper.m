...
#import "JHGradientHelper.h"

@implementation JHGradientHelper
...
+ (UIImage *)getLinearGradientImage:(UIColor *)startColor and:(UIColor *)endColor directionType:(JHGradientDirection)directionType option:(CGSize)size
{
    ...
    if (directionType == JHLinearGradientDirectionLevel) {
        gradientLayer.startPoint = CGPointMake(0, 0);
        gradientLayer.endPoint = CGPointMake(1, 0);
    }else if (directionType == JHLinearGradientDirectionVertical){
        gradientLayer.startPoint = CGPointMake(0, 0);
        gradientLayer.endPoint = CGPointMake(0, 1);
    }else if (directionType == JHLinearGradientDirectionUpwardDiagonalLine){
        gradientLayer.startPoint = CGPointMake(0, 0);
        gradientLayer.endPoint = CGPointMake(1, 1);
    }else if (directionType == JHLinearGradientDirectionDownDiagonalLine){
...
+ (void)addGradientChromatoAnimation:(UIView *)view withHSBArr:(NSArray *)colors
{
    ...
    [chromatoLayer setColors:colors];
...
+ (CAKeyframeAnimation *)createGradientChromatoKeyAnimation
{
    ...
    chromateAnimate.values = @[@[(__bridge id)JHColorHSB(0.63, 0.69, 0.88).CGColor, (__bridge id)JHColorHSB(0.75, 0.69, 0.88).CGColor],
                               @[(__bridge id)JHColorHSB(0.73, 0.69, 0.88).CGColor, (__bridge id)JHColorHSB(0.85, 0.69, 0.88).CGColor],
                               @[(__bridge id)JHColorHSB(0.83, 0.69, 0.88).CGColor, (__bridge id)JHColorHSB(0.95, 0.69, 0.88).CGColor],
                               @[(__bridge id)JHColorHSB(0.88, 0.69, 0.88).CGColor, (__bridge id)JHColorHSB(1, 0.69, 0.88).CGColor],
                               @[(__bridge id)JHColorHSB(0.98, 0.69, 0.88).CGColor, (__bridge id)JHColorHSB(0.1, 0.69, 0.88).CGColor],
                               @[(__bridge id)JHColorHSB(1, 0.69, 0.88).CGColor, (__bridge id)JHColorHSB(0.12, 0.69, 0.88).CGColor],
                               @[(__bridge id)JHColorHSB(0.1, 0.69, 0.88).CGColor, (__bridge id)JHColorHSB(0.22, 0.69, 0.88).CGColor],
                               @[(__bridge id)JHColorHSB(0.2, 0.69, 0.88).CGColor, (__bridge id)JHColorHSB(0.32, 0.69, 0.88).CGColor],
                               @[(__bridge id)JHColorHSB(0.3, 0.69, 0.88).CGColor, (__bridge id)JHColorHSB(0.42, 0.69, 0.88).CGColor],
                               @[(__bridge id)JHColorHSB(0.4, 0.69, 0.88).CGColor, (__bridge id)JHColorHSB(0.52, 0.69, 0.88).CGColor],
                               @[(__bridge id)JHColorHSB(0.5, 0.69, 0.88).CGColor, (__bridge id)JHColorHSB(0.62, 0.69, 0.88).CGColor],
                               @[(__bridge id)JHColorHSB(0.6, 0.69, 0.88).CGColor, (__bridge id)JHColorHSB(0.72, 0.69, 0.88).CGColor],
                               @[(__bridge id)JHColorHSB(0.63, 0.69, 0.88).CGColor, (__bridge id)JHColorHSB(0.75, 0.69, 0.88).CGColor]];
